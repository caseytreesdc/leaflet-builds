...
NVP_20210510 = {
    'preheader': "and celebrating AAPI Heritage through trees",
    'article-1__link': 'https://caseytrees.org/2021/05/top-10-most-wanted-trees/?utm_source=leaflet&utm_medium=email&utm_campaign=programming',
    'article-1__alt-text': 'flowering residential tree in front of row houses',
    'article-1__image': 'https://caseytrees.org/wp-content/uploads/2021/05/top-ten-residential-trees-email.png',
    'article-1__heading': 'Top 10 Most Wanted Trees',
    'article-1__description': 'The good kind! Here are our most popularly planted trees of the past year',
    ...
    'article-2__description': 'The literal, monetary value of trees, some quantifuable impacts',
    'article-3__link': 'https://caseytrees.org/2021/05/celebrating-asian-american-and-pacific-islander-aapi-heritage-month-through-cherry-trees/?utm_source=leaflet&utm_medium=email&utm_campaign=nationalholiday',
    'article-3__alt-text': 'the "Japanese Lantern" statue at the Tidal Basin, lighted during the Cherry Blossom festival.',
    'article-3__image': 'https://caseytrees.org/wp-content/uploads/2021/05/aapi-cherry-blossoms-email.png',
    'article-3__heading': 'Celebrating Asian American and Pacific Islander (AAPI) Heritage Month through Cherry Trees',
    'article-3__description': 'Our city’s claim to fame is thanks to a Japanese gift of friendship',
    ...
    'banner-b__image-browser': 'https://caseytrees.org/wp-content/uploads/2021/05/trc-2020-article.png',
    'banner-b__image-responsive': 'https://caseytrees.org/wp-content/uploads/2021/05/trc-2020-article.png',
